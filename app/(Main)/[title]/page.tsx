...
export default async function ArticlePage({
  ...
  return (
    <main
      className="relative min-h-screen bg-main-background overflow-hidden"
      dir="rtl">
      {/* Doodles */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <svg
          className="absolute top-16 right-[4%] w-16 opacity-15 stroke-main-color fill-none stroke-2"
          viewBox="0 0 100 100">
          <path d="M50,10 L60,40 L90,40 L65,60 L75,90 L50,70 L25,90 L35,60 L10,40 L40,40 Z" />
        </svg>
        <svg
          className="absolute top-[40%] left-[2%] w-20 opacity-10 stroke-main-color fill-none stroke-2"
          viewBox="0 0 50 50">
          <circle cx="25" cy="25" r="20" strokeDasharray="5,5" />
        </svg>
        <svg
          className="absolute bottom-24 right-[6%] w-14 opacity-10 stroke-main-color fill-none stroke-2"
          viewBox="0 0 100 100">
      ...
      <div className="max-w-5xl mx-auto px-6 py-24 relative z-10">
        ...
        {/* Article card */}
        <article className="bg-card-background rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(0,166,133,0.12)] border border-main-color/10">
          {/* Cover image */}
          {article.coverImage && (
        ...
        <div className="mt-10 text-center">
          <Link
            ...
            className="inline-flex items-center gap-2 font-black text-sm uppercase tracking-wide
              bg-main-color text-white px-7 py-3.5 rounded-full
